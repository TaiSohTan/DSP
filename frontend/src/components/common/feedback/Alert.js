...
/**
 * Alert component for displaying various types of feedback messages
 */
const Alert = ({
  type = 'info',
  title,
  ...
  return (
    <div 
      className={`border-l-4 p-4 rounded-r-md ${styles.container} ${className}`}
      role="alert"
    >
      <div className="flex items-start">
        ...
        {onClose && (
          <button 
            onClick={onClose}
            className={`ml-3 ${styles.icon} hover:text-gray-500`}
