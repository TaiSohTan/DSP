      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h3 className="text-xl font-bold mb-2">VoteChain</h3>
            <p className="text-gray-400">
              Ethereum-Based Blockchain E-Voting System.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/elections" className="text-gray-400 hover:text-white transition">
                    Elections
                  </Link>
                </li>
                <li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="https://github.com/TaiSohTan/DSP.git" className="text-gray-400 hover:text-white">
